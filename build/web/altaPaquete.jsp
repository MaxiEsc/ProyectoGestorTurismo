<%-- 
    ...
    Created on : 13/12/2021, 17:58:49
    Author     : Max Esc
--%>
            ...
            <section> 
                ...
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para dar alta a un paquete </p>
                    </div>

                    <form action="AltaPaqueteTuristico" method="post" class="form-check">
                        <div class="mb-3 row ">
