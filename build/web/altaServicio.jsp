<%-- 
    ...
    Created on : 13/12/2021, 17:59:38
    Author     : Max Esc
--%>
            ...
            <section> 
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para dar alta a un Servicio Turistico </p>
                    </div>

                    <form action="AltaServicioTuristico" method="post" class="form-check">
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Nombre: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nomVentas" required>
                            </div>
                        </div>
                        <div class="mb-3 row ">
