<%-- 
    ...
    Created on : 13/12/2021, 18:13:17
    Author     : Max Esc
--%>
            ...
            <section> 
                ...
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para Modificar a una venta </p>
                    </div>

                    <form action="ModificarVentas" method="post" class="form-check">

                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Numero de venta: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="numVentas" required />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">Fecha de Venta: </label>
                            <div class="col-sm-10">
                                <input type="date" name="fechaVentas" min="1900-01-01" max="2070-31-12" step="1" class="form-control" required />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">Medio de Pago: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="medioPago" required />
                            </div>
                        </div>                        
