<%-- 
    Document   : borrarServicio
    Created on : 13/12/2021, 18:03:26
    Author     : Max Esc
--%>
            ...
            <section>
                ...
                <div class="contianer">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para Borrar un Servicio </p>
                    </div>

                    <form action="BajaServicioTuristico" method="post" class="form-check">
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Id del Servicio a borrar: </label>
                            <div class="col-sm-10">
