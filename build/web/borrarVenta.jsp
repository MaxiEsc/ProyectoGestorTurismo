<%-- 
    Document   : borrarVenta
    Created on : 13/12/2021, 18:04:06
    Author     : Max Esc
--%>
            ...
            <section> 
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para Borrar una Venta </p>
                    </div>

                    <form action="BajaVentas" method="post" class="form-check">
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Id de la Venta a borrar: </label>
                            <div class="col-sm-10">
