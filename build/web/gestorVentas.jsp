<%-- 
    Document   : gestorVentas
    Created on : 13/12/2021, 18:08:43
    Author     : Max Esc
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <section class="listas row"> 
                <div class="container bg-dark text-white"> 
                    <p>Lista de Ventas en el sistema </p>
                </div>
                <div class="container">
                    <button class="btn btn-warning">Lista de Ventas </button>
                </div>
                <div class="container">
                    <table class="table table-dark">
                        ...
                        <%
                            List<Ventas> todos = (List<Ventas>) request.getAttribute("ventas");
                            for (Ventas vt : todos) {
                        %>

                        <tbody>
                            <tr>
                                <th scope="row"><%= vt.getNum_ventas()%></th>
                                <td><%= vt.getFecha_venta()%></td>
                                <td><%= vt.getMedio_pago()%></td>                                
                            </tr>
                        </tbody>
                        <%
                            }
                    ...
                    <div class="container">		
                        ...
                        <button class="btn btn-warning">
                            <div class="container">
                                <a href="altaVentas.jsp"> Nuevo Venta</a>
                            </div>
                        </button>
                        <button class="btn btn-warning">
                            <div class="container">
                                <a href="modificarVentas.jsp">Modificar un Venta</a>
                            </div>
                        </button>
                        <button class="btn btn-warning">
                            <div class="container">
                                <a href="borrarVenta.jsp">Eliminar un Venta</a>
                            </div>
                        </button>
                    </div>
                </div>
