<%-- 
    ...
    Created on : 13/12/2021, 18:12:12
    Author     : Max Esc
--%>
            ...
            <section> 
                ...
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para Modificar un paquete </p>
                    </div>

                    <form action="ModificarPaqueteTuristico" method="post" class="form-check">
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Id del Paquete: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="idPaquete" required />
                            </div>
                        </div>
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Costo del paquete: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="costoPaquete" required />
                            </div>
                        </div>
