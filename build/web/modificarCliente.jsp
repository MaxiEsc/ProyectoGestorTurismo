<%-- 
    ...
    Created on : 13/12/2021, 18:10:46
    Author     : Max Esc
--%>
            ...
            <section> 
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para modificar a un Cliente</p>
                    </div>
                    <form action="ModificarCliente" method="post" class="form-check">
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">ID a Modificar: </label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="regPassword"name="id" required />
                            </div>
                        </div>
                        <div class="mb-3 row ">
                        ...
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">DNI: </label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="regPassword"name="dni" required />
                            </div>
                        </div>
                        <div class="mb-3 row">
