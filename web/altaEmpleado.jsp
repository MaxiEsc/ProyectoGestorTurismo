<%-- 
    ...
    Created on : 13/12/2021, 17:58:05
    Author     : Max Esc
--%>
            ...
            <section> 
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para dar alta a un Empleado</p>
                    </div>

                    <form action="AltaEmpleado" method="post" class="form-check">
                        <div class="mb-3 row ">
                        ...
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">Sueldo: </label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="regPassword"name="sueldo" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
