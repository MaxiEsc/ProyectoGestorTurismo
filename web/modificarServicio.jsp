<%-- 
    ...
    Created on : 13/12/2021, 18:12:52
    Author     : Max Esc
--%>
            ...
            <section> 
                ...
                <div class="container">
                    <div class="container bg-dark text-white"> 
                        <p>Ingrese los datos necesarios para Modificar un Servicio Turistico </p>
                    </div>

                    <form action="ModificarServicioTuristico" method="post" class="form-check">
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">Id Servicio: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="idServicio" required />
                            </div>
                        </div>    
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Nombre: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="numServicio" required />
                            </div>
                        </div>
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Destino Servicio: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="destinoServicio" required />
                            </div>
                        </div>
                        <div class="mb-3 row ">
                            <label for="text" class="col-sm-2 col-form-label">Descripcion Breve: </label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="descripcionBreve" required />
                            </div>
                        </div>    
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">Costo Servicio: </label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="costoServicio" required />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="password" class="col-sm-2 col-form-label">Fecha de Servicio: </label>
                            <div class="col-sm-10">
                                <input type="date" name="fechaServicio" min="1900-01-01" max="2070-31-12" step="1" class="form-control" required />
                            </div>
                        </div>
